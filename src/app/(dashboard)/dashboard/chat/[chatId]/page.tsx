...
const getMessages = async (chatId: string) => {
    try {
        ...
        const messages = messageArrayValidator.parse(revDbMessages)
        return messages
            ...
            <div className='flex sm:items-center justify-between py-3 border-b-2 border-gray-200'>
                <div className='relative flex items-center gap-x-4'>
                    ...
                    <div className='flex flex-col leading-tight'>
                        ...
                        <span className='text-gray-600'>{chatPartner.email}</span>
                    </div>
                </div>
            </div>
            <Messages initialMessages={initialMessages} sessionUser={session.user} chatPartner={chatPartner} chatId={chatId} />
